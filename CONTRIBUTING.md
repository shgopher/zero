The zero community wants to be helped by a wide range of developers, so you'd like to take a few minutes to read this guide before you mention the problem or pull request.

## Reporting Bug or Fixing Bugs
We use GitHub issues to manage issues. If you want to submit , first make sure you've searched for existing issues, pull requests and read our [FAQ](https://zero.com/docs/intro/faq).
...
- **uc**: changes related to `zero-usercenter`
- **apiserver**: changes related to `zero-apiserver`
- **gw**: changes related to `zero-gateway`
- **nightwatch**: changes related to `zero-nightwatch`
- **pump**: changes related to `zero-pump`
- **minerset**: changes related to `zero-minerset-controller`
- **miner**: changes related to `zero-miner-controller`
- **cm**: changes related to `zero-controller-manager`

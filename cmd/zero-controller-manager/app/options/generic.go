...
import (
	...
	cmconfig "github.com/superproj/zero/internal/controller/apis/config"
	cmoptions "github.com/superproj/zero/pkg/config/options"
)
...
func (o *GenericControllerManagerConfigurationOptions) AddFlags(fss *cliflag.NamedFlagSets) {
	...
	genericfs.StringVar(&o.Namespace, "namespace", o.Namespace, "Namespace that the controller watches to reconcile zero-apiserver objects. "+

...
func callHTTP() {
	conn, err := transhttp.NewClient(
		...
		transhttp.WithEndpoint("zero.usercenter.superproj.com:18080"),
	)
	if err != nil {
		panic(err)
	}
	...
	reply, err := client.Login(context.Background(), &v1.LoginRequest{Username: "colin", Password: "zero(#)666"})
	if err != nil {
		log.Fatal(err)
	}
...
func callGRPC() {
	conn, err := transgrpc.DialInsecure(
		context.Background(),
		transgrpc.WithEndpoint("zero.usercenter.superproj.com:18080"),

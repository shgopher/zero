...
Launch a zero usercenter server
...
```
      ...
      --client.user-agent string                         Used to specify the Resty client User-Agent. (default "zero")
  ...
  -h, --help                                             help for zero-usercenter

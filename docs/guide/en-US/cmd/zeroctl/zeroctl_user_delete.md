...
Delete a user resource from zero platform (Administrator rights required)

### Synopsis

Delete a user resource from zero platform, only administrator can do this operation.

```
zeroctl user delete USERNAME
```

...
* [zeroctl jwt show](zeroctl_jwt_show.md)	 - Show header and claims for a JWT token
* [zeroctl jwt sign](zeroctl_jwt_sign.md)	 - Sign a jwt token with given secretID and secretKey
* [zeroctl jwt verify](zeroctl_jwt_verify.md)	 - Verify a JWT token

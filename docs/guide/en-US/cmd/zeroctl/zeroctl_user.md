...
Manage users on zero cloud platform
...
* [zeroctl user create](zeroctl_user_create.md)	 - Create a user resource
* [zeroctl user delete](zeroctl_user_delete.md)	 - Delete a user resource from zero platform (Administrator rights required)
* [zeroctl user get](zeroctl_user_get.md)	 - Display a user resource.
* [zeroctl user list](zeroctl_user_list.md)	 - Display all users in zero platform (Administrator rights required)
* [zeroctl user update](zeroctl_user_update.md)	 - Update a user resource

...
Create a user on zero cloud platform. If nickname not specified, username will be used.

```
zeroctl user create USERNAME PASSWORD EMAIL
```
...
```
      --email string      The email of the user. (default "colin@zero.com")
  -h, --help              help for create
      --nickname string   The nickname of the user.
      --phone string      The phone number of the user. (default "1812884xxxx")
```

...
zeroctl controls the zero cloud platform
...
* [zeroctl color](zeroctl_color.md)	 - Print colors supported by the current terminal
* [zeroctl completion](zeroctl_completion.md)	 - Output shell completion code for the specified shell (bash, zsh, fish, or powershell)
* [zeroctl info](zeroctl_info.md)	 - Print the host information
* [zeroctl jwt](zeroctl_jwt.md)	 - JWT command-line tool
* [zeroctl new](zeroctl_new.md)	 - Generate demo command code
* [zeroctl options](zeroctl_options.md)	 - Print the list of flags inherited by all commands
* [zeroctl secret](zeroctl_secret.md)	 - Manage secrets on zero platform
* [zeroctl user](zeroctl_user.md)	 - Manage users on zero cloud platform
* [zeroctl validate](zeroctl_validate.md)	 - Validate the basic environment for zeroctl to run
* [zeroctl version](zeroctl_version.md)	 - Print the client and server version information

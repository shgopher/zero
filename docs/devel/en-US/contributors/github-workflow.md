...
description: |
  ...
  Zero project. It includes tips and suggestions on keeping your
...
1. Visit https://github.com/superproj/zero
2. Click `Fork` button (top right) to establish a cloud-based fork.

## 2. Clone fork to local storage

Per Go's [workspace instructions][go-workspace], place Zero' code on your
...
mkdir -p $working_dir
cd $working_dir
git clone https://github.com/$user/zero.git
# or: git clone git@github.com:$user/zero.git

cd $working_dir/zero
git remote add upstream https://github.com/superproj/zero.git
# or: git remote add upstream git@github.com:zero/zero.git
...
This workflow is process-specific. For quick-start build instructions for [zero/zero](https://git.k8s.io/zero), please [see here](/contributors/devel/development.md#building-kubernetes-on-a-local-osshell-environment).
...
1. Visit your fork at `https://github.com/<user>/zero`

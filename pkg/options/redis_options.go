...
type RedisOptions struct {
	...
	MinIdleConn  int           `json:"min-idle-conn" mapstructure:"min-idle-conn"`
...
func (o *RedisOptions) AddFlags(fs *pflag.FlagSet, prefixs ...string) {
	...
	fs.IntVar(&o.MinIdleConn, "redis.min-idle-conn", o.MinIdleConn, ""+
...
func NewClient(o *RedisOptions) (*redis.Client, error) {

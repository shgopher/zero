...
type HealthOptions struct {
	// Enable debugging of zero pump by exposing profiling information.
...
func NewHealthOptions() *HealthOptions {
	return &HealthOptions{
		...
		HealthCheckAddress: "0.0.0.0:9090",
	}
}
...
func (o *HealthOptions) ServeHealthCheck() {
	...
	r.HandleFunc(o.HealthCheckPath, handler).Methods("GET")
	if o.HTTPProfile {
	...
	if err := http.ListenAndServe(o.HealthCheckAddress, r); err != nil {
		log.Fatalf("Error serving health check endpoint: %w", err)
	}
}

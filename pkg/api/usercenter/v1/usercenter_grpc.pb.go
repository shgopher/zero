...
func (c *userCenterClient) CreateSecret(ctx context.Context, in *CreateSecretRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (UnimplementedUserCenterServer) CreateSecret(context.Context, *CreateSecretRequest) (*emptypb.Empty, error) {

...
const (
	...
	DisableMinerCreateAnnotation = "apps.zero.io/disable-miner-create"
	...
	// WatchLabel is a label othat can be applied to any Zero API object.
	//
	...
	WatchLabel = "apps.zero.io/watch-filter"

	// PausedAnnotation is an annotation that can be applied to any Zero API
	// object to prevent a controller from processing a resource.
	//
	// Controllers working with Zero objects must check the existence of this annotation
	// on the reconciled object.
	PausedAnnotation = "apps.zero.io/paused"
	...
	MinerSkipRemediationAnnotation = "apps.zero.io/skip-remediation"
)

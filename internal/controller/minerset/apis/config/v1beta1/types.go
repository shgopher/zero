...
const (
	...
	// MinerSetControllerDefaultLockObjectName defines default minerset controller lock object name ("zero-minerset-controller").
	MinerSetControllerDefaultLockObjectName = "zero-minerset-controller"
)
...
type MinerSetControllerConfiguration struct {
	...
	// If unspecified, the controller watches for zero-apiserver objects across all namespaces

...
import (
	...
	v1clientset "github.com/superproj/zero/pkg/generated/clientset/versioned/typed/core/v1"
)
...
func (r *NamespacedResourcesDeleter) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *NamespacedResourcesDeleter) deleteCollection(gvr schema.GroupVersionResource, namespace string) (bool, error) {
	...
	//nolint:kubelistcheck,nolintlint

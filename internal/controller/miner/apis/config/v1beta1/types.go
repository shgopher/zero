...
const (
	...
	// MinerControllerDefaultLockObjectName defines default miner controller lock object name ("zero-miner-controller").
	MinerControllerDefaultLockObjectName = "zero-miner-controller"
)

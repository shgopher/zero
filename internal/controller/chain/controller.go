...
func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (_ ctrl.Result, reterr error) {
	...
	ctx, log, err := logutil.AddOwners(ctx, r.client, ch)
	if err != nil {
...
// MinerToChains is a handler.ToRequestsFunc to be used to enqueue requests for reconciliation
// for Chains that might adopt an orphaned Miner.
func (r *Reconciler) MinerToChains(o client.Object) []ctrl.Request {
	result := []ctrl.Request{}

...
func (r *MinerSyncReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.client.Get(ctx, req.NamespacedName, m); err != nil {
		if apierrors.IsNotFound(err) {
			return ctrl.Result{}, r.Store.Miners().Delete(ctx, map[string]interface{}{"namespace": req.Namespace, "name": req.Name})
		}
		return ctrl.Result{}, err
	}

	mr, err := r.Store.Miners().Get(ctx, map[string]interface{}{"namespace": req.Namespace, "name": req.Name})
	if err != nil {

...
//go:generate mockgen -self_package github.com/superproj/zero/internal/gateway/biz/miner -destination mock_miner.go -package miner github.com/superproj/zero/internal/gateway/biz/miner MinerBiz
...
import (
	...
	"github.com/superproj/zero/internal/pkg/meta"
	...
	listers "github.com/superproj/zero/pkg/generated/listers/apps/v1beta1"
	"github.com/superproj/zero/pkg/log"
)

// MinerBiz defines functions used to handle miner request.
type MinerBiz interface {
	Create(ctx context.Context, namespace string, m *v1beta1.Miner) error
	List(ctx context.Context, namespace string, req *v1.ListMinerRequest) (*v1.ListMinerResponse, error)
...
func (b *minerBiz) List(ctx context.Context, namespace string, req *v1.ListMinerRequest) (*v1.ListMinerResponse, error) {
	total, list, err := b.ds.Miners().List(ctx, namespace, meta.ListOffset(req.Offset), meta.ListLimit(req.Limit))
	if err != nil {
...
func (b *minerBiz) Get(ctx context.Context, namespace, name string) (*v1beta1.Miner, error) {
	...
	if err != nil {
		log.Errorw(err, "Failed to get miner")
		return nil, err
	}

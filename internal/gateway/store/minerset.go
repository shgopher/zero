...
import (
	...
	"github.com/superproj/zero/internal/gateway/model"
...
// db is an alias for d.ds.CoreDB(ctx context.Context), a convenience method to get the core database instance.
func (d *minerSetStore) db(ctx context.Context) *gorm.DB {
	return d.ds.CoreDB(ctx)
}

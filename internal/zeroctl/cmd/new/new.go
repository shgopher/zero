...
import (
	...
	fileutil "github.com/superproj/zero/pkg/util/file"
)
...
to quickly create a Cobra application.{{.Dot}})
	...
	{{.CommandName}}Example = templates.Examples({{.Dot}}
		...
		zeroctl {{.CommandName}} superproj superprojpass{{.Dot}})
...
to quickly create a Cobra application.{{.Dot}})
	...
	subcmd1Example = templates.Examples({{.Dot}}
		...
		zeroctl {{.CommandName}} subcmd1 superproj superprojpass

		# Print all option values for subcmd1 with --persistent specified
		zeroctl {{.CommandName}} subcmd1 superproj superprojpass --persistent="specified persistent option in command line"{{.Dot}})
...
to quickly create a Cobra application.{{.Dot}})
	...
	subcmd2Example = templates.Examples({{.Dot}}
		...
		zeroctl {{.CommandName}} subcmd2{{.Dot}})
)

...
//
// This method is generic to the command in use and may be used by non-ZERO
// commands.
...
//
// This method is meant specifically for `zeroctl diff` and may be used
// by other commands.
...
// func with that string and an zeroctl exit code.

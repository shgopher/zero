...
const (
	// recommendedHomeDir 定义放置 zero 服务配置的默认目录.
	recommendedHomeDir = ".zero"

	// defaultConfigName 指定了 zero 服务的默认配置文件名.
	defaultConfigName = "zeroctl.yaml"
)
...
func initConfig(cfgFile string) {
	...
	// 读取环境变量的前缀为 ZERO，如果是 zero，将自动转变为大写。

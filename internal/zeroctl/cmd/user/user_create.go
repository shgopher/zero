...
var (
	createLong = templates.LongDesc(`Create a user on zero cloud platform.
If nickname not specified, username will be used.`)

	createExample = templates.Examples(`
		# Create user with given input
		zeroctl user create foo Foo@2023

		# Create user wt 
		zeroctl user create foo Foo@2023 --email=foo@foxmail.com --phone=18128845xxx --nickname=colin`)

...
import (
	...
	"github.com/superproj/zero/internal/pkg/middleware/authn/jwt"
...
func NewMiddlewares(logger log.Logger, a authn.Authenticator, v validate.ICustomValidator) []middleware.Middleware {

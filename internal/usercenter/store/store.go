...
//go:generate mockgen -self_package github.com/superproj/zero/internal/usercenter/store -destination mock_store.go -package store github.com/superproj/zero/internal/usercenter/store IStore,SecretStore,UserStore
...
// CoreDB retrieves the current transactional DB instance if it exists

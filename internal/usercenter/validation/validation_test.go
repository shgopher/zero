...
func TestNew(t *testing.T) {
	...
	tests := []struct {
		name    string
		args    args
		want    validation.CustomValidator
		wantErr bool
	}{
		{
			name: "default",
...
func Test_validator_ValidateCreateUserRequest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{context.Background(), &v1.CreateUserRequest{
				Username: "colin",
				Nickname: "colin",
				Password: "zero(#)666",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := vd.ValidateCreateUserRequest(tt.args.ctx, tt.args.req); (err != nil) != tt.wantErr {
...
func Test_validator_ValidateListUserRequest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				ctx: zerox.NewUserID(context.Background(), "user-admin"),
				req: &v1.ListUserRequest{
					Limit:  0,
					Offset: 10,
				},
		...
		},
		{
			...
			args: args{
				ctx: zerox.NewUserID(context.Background(), "user-xxx"),
				req: &v1.ListUserRequest{
					Limit:  0,
					Offset: 10,
				},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := vd.ValidateListUserRequest(tt.args.ctx, tt.args.req); (err != nil) != tt.wantErr {
...
func Test_validator_ValidateCreateSecretRequest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				ctx: zerox.NewUserID(context.Background(), "user-test"),
				req: &v1.CreateSecretRequest{
					Name:        "test",
					Expires:     0,
					Description: "test",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := vd.ValidateCreateSecretRequest(tt.args.ctx, tt.args.req); (err != nil) != tt.wantErr {
...
func Test_validator_ValidateAuthRequest(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := vd.ValidateAuthRequest(tt.args.ctx, tt.args.req); (err != nil) != tt.wantErr {
...
func Test_validator_ValidateAuthorizeRequest(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := vd.ValidateAuthorizeRequest(tt.args.ctx, tt.args.req); (err != nil) != tt.wantErr {

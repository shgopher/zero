...
func merge(conditions []localizedCondition, targetCondition appsv1beta1.ConditionType, options *mergeOptions) *appsv1beta1.Condition {
...
func (g conditionGroups) TrueGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionTrue, appsv1beta1.ConditionSeverityNone)
}
...
func (g conditionGroups) ErrorGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionFalse, appsv1beta1.ConditionSeverityError)
}
...
func (g conditionGroups) WarningGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionFalse, appsv1beta1.ConditionSeverityWarning)
}

func (g conditionGroups) getByStatusAndSeverity(status corev1.ConditionStatus, severity appsv1beta1.ConditionSeverity) *conditionGroup {
	if len(g) == 0 {
		return nil
	}
	for _, group := range g {
...
type conditionGroup struct {
	...
	severity   appsv1beta1.ConditionSeverity
...
func (g conditionGroup) mergePriority() int {
	...
	case corev1.ConditionFalse:
		switch g.severity {
		case appsv1beta1.ConditionSeverityError:
			return 0
		case appsv1beta1.ConditionSeverityWarning:
			return 1
		case appsv1beta1.ConditionSeverityInfo:
			return 2
		}

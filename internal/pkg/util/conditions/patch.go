...
type PatchOperation struct {
	Before *appsv1beta1.Condition
	After  *appsv1beta1.Condition
...
func (o *applyOptions) isOwnedCondition(t appsv1beta1.ConditionType) bool {
...
func WithOwnedConditions(t ...appsv1beta1.ConditionType) ApplyOption {

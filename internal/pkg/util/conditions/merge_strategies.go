...
type mergeOptions struct {
	conditionTypes                     []appsv1beta1.ConditionType
	addSourceRef                       bool
	addStepCounter                     bool
	addStepCounterIfOnlyConditionTypes []appsv1beta1.ConditionType
	stepCounter                        int
}
...
func WithConditions(t ...appsv1beta1.ConditionType) MergeOption {
...
// IMPORTANT: This options works only while generating the Summary condition.
func WithStepCounterIfOnly(t ...appsv1beta1.ConditionType) MergeOption {
	return func(c *mergeOptions) {
...
func getFirstReason(g conditionGroups, order []appsv1beta1.ConditionType, addSourceRef bool) string {
...
func getFirstMessage(groups conditionGroups, order []appsv1beta1.ConditionType) string {
...
func getFirstCondition(g conditionGroups, priority []appsv1beta1.ConditionType) *localizedCondition {
	topGroup := g.TopGroup()
	if topGroup == nil {
		return nil
	}

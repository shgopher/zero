...
// Package core implements utilities.
package core
...
func GetMinerIfExists(ctx context.Context, c client.Client, namespace, name string) (*appsv1beta1.Miner, error) {
	if c == nil {
...
func GetClusterFromMetadata(ctx context.Context, c client.Client, obj metav1.ObjectMeta) (*appsv1beta1.Cluster, error) {
	if obj.Labels[appsv1beta1.ClusterLabelName] == "" {
		return nil, errors.WithStack(ErrNoCluster)
	}
	return GetClusterByName(ctx, c, obj.Namespace, obj.Labels[appsv1beta1.ClusterLabelName])
}

// GetOwnerCluster returns the Cluster object owning the current resource.
func GetOwnerCluster(ctx context.Context, c client.Client, obj metav1.ObjectMeta) (*appsv1beta1.Cluster, error) {
...
func GetClusterByName(ctx context.Context, c client.Client, namespace, name string) (*appsv1beta1.Cluster, error) {
	cluster := &appsv1beta1.Cluster{}
...
func ClusterToInfrastructureMapFunc(ctx context.Context, gvk schema.GroupVersionKind, c client.Client, providerCluster client.Object) handler.MapFunc {
	...
	return func(o client.Object) []reconcile.Request {
		cluster, ok := o.(*appsv1beta1.Cluster)
		if !ok {
			return nil
		}
...
func GetOwnerMiner(ctx context.Context, c client.Client, obj metav1.ObjectMeta) (*appsv1beta1.Miner, error) {
	for _, ref := range obj.OwnerReferences {
		gv, err := schema.ParseGroupVersion(ref.APIVersion)
		if err != nil {
			return nil, err
		}
		if ref.Kind == "Miner" && gv.Group == appsv1beta1.SchemeGroupVersion.Group {
...
func GetMinerByName(ctx context.Context, c client.Client, namespace, name string) (*appsv1beta1.Miner, error) {
	m := &appsv1beta1.Miner{}
...
/*
// MinerToInfrastructureMapFunc returns a handler.ToRequestsFunc that watches for
// Miner events and returns reconciliation requests for an infrastructure provider object.
func MinerToInfrastructureMapFunc(gvk schema.GroupVersionKind) handler.MapFunc {
	return func(o client.Object) []reconcile.Request {
		m, ok := o.(*appsv1beta1.Miner)
		if !ok {
			return nil
		}
...
// MinerSetToObjectsMapper returns a mapper function that gets a minerset and lists all objects for the object passed in
// and returns a list of requests.
// NB: The objects are required to have `appsv1beta1.MinerSetNameLabel` applied.
func MinerSetToObjectsMapper(c client.Client, ro client.ObjectList, scheme *runtime.Scheme) (handler.MapFunc, error) {
	...
	return func(o client.Object) []ctrl.Request {
		...
		listOpts := []client.ListOption{
			client.MatchingLabels{
				appsv1beta1.MinerSetNameLabel: ms.Name,
			},
		}

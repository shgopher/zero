...
import (
	...
	printersutil "github.com/superproj/zero/internal/pkg/util/printers"
...
// AddHandlers adds print handlers for default Zero types dealing with internal versions.
